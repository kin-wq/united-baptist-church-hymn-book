...
export default function TabLayout() {
  ...
  return <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: "#7A1118", tabBarInactiveTintColor: "#536777", tabBarStyle: { paddingTop: 8, paddingBottom: bottomPadding, height: 60 + bottomPadding, backgroundColor: "rgba(255,255,255,0.78)", borderTopColor: "rgba(11,46,89,0.14)", borderTopWidth: 1 }, tabBarLabelStyle: { fontSize: 11, fontWeight: "700" } }}>
